...
try {
    ...
    if ($method === 'POST' && $action === 'close_ticket') {
        ...
        // NOVO: Disparo de E-mail de Conclusão de Chamado
        if ($new_status === 'Concluído' || $new_status === 'Sem Solução') {
            try {
                ...
                if ($details && !empty($details['requester_email'])) {
                    ...
                    <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
                        <div style='padding: 20px; border: 1px solid #ddd; border-radius: 5px; background: #f9f9f9;'>
                            ...
                            <p style='margin-bottom: 10px;'><b>Título:</b> {$details['title']}</p>
                ...
                // Ignora erro de email para não quebrar o fechamento do chamado
