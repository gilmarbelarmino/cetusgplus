 ...
 * TECNOLOGIA VIEW
 * ===============
 * Arquivo de apresentação (View) do módulo de Tecnologia.
 * Todas as variáveis são injetadas pelo TecnologiaController.
 * 
 * Variáveis disponíveis:
 * $cameras, $remotes, $emails, $all_users,
 * $note_sections, $notes, $active_section_id,
 * $active_note_id, $active_note, $activeTab, $tech_pass
 */

// Função auxiliar para cores (necessária no template)
